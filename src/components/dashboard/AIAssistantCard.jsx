...
export default function AIAssistantCard({ insight }) {
  return (
    <div className="relative overflow-hidden rounded-2xl border border-navy-700/40 bg-gradient-to-br from-navy-900 via-navy-850 to-navy-800 p-5 text-white shadow-pop">
      ...
      <button className="relative mt-4 flex w-full items-center justify-center gap-1.5 rounded-lg bg-white/10 py-2 text-xs font-medium text-white transition-colors hover:bg-white/15">
